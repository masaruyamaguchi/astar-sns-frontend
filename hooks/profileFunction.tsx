...
export const checkCreatedInfo = async (props: PropsCCI) => {
  ...
  //debug
  console.log('checkCreatedInfo ym profile id:', props.userId);
...
export const getProfileForProfile = async (props: PropsGPFP) => {
  const contract = new ContractPromise(props.api!, abi, contractAddress);
  //debug
  console.log('getProfileForProfile1 ym profile id:', props.userId);
  ...
  //debug
  console.log('getProfileForProfile2 ym profile id:', props.userId);
